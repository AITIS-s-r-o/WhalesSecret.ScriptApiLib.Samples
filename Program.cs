...
public class Program
{
    ...
    private static readonly object[][] sampleDescriptions = new object[][]
    {
        ...
        new object[] { "Subscriptions/OrderBook.Basic", typeof(OrderBookBasic), "Basic order book subscription sample. Demonstrates how order book subscription can be created and "
            + "consumed."},
