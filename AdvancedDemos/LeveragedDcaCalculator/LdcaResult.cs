...
public class LdcaResult
{
    ...
    /// <summary>Sum of the paid trading fees.</summary>
    public decimal TradeFeesPaid { get; }
    ...
    /// <param name="tradeFeesPaid">Sum of the paid trade fees.</param>
        ...
        decimal totalValue, decimal totalInvestedAmount, decimal profitPercent, decimal fundingRatePaid)
    {
        ...
        this.TradeFeesPaid = tradeFeesPaid;
    ...
    public override string ToString()
    {
        ...
        (
            ...
            nameof(this.TradeFeesPaid), this.TradeFeesPaid,
